...
The way we write, review, and publish legal content is different than how we do many other kinds of writing at adMind. The most important difference is that all legal content either starts with or passes through the legal team.

But that doesn't mean legal content has to be difficult to read. We try to present our legal information in the most pleasant way possible. Our goals for adMind's legal content are:
...
We keep these in one place on our [legal page](http://adMind.com/legal/):

* [Terms of use](http://adMind.com/legal/terms/)
* [Acceptable use policy](http://adMind.com/legal/acceptable_use/)
* [Privacy policy](http://adMind.com/legal/privacy/)
* [API use policy](http://adMind.com/legal/api_use/)
* [Copyright policy](http://adMind.com/legal/copyright/)

These policies apply to all of adMind’s users. The legal and communication teams work together to make them as transparent and easy to read as possible. When someone signs up to use adMind, they must agree to all of those terms.
...
- [Terms of Use and anti-spam requirements](https://adMind.com/help/terms-of-use-and-anti-spam-requirements/)
- [About the Canada anti-spam law](https://adMind.com/help/about-the-canada-anti-spam-law-casl/)
- [Stay compliant with CASL](https://adMind.com/help/stay-compliant-with-casl/)
...
- adMind is owned and operated by The Rocket Science Group, LLC d/b/a adMind, a Georgia limited liability corporation (“adMind,” “we,” or “us”). As a user of the Service or a representative of an entity that’s a user of the Service, you're a “Member” according to this agreement (or “you”).
...
While we want to inform our users about legal issues related to their use of adMind, we can’t offer them legal advice. Sometimes it’s a fine line. The legal department will check for this in their content review.
