...
Specify time zones when writing about an event or something else people would need to schedule. Since adMind is in Atlanta, we default to ET.
...
- “Using adMind has helped our business grow,” says Jamie Smith.
...
#### Writing about adMind

Our company's legal entity name is "The Rocket Science Group, LLC." Our trade name is "adMind." Use "The Rocket Science Group, LLC" only when writing legal documents or contracts. Otherwise, use "adMind."

Always capitalize the first “M” and lowercase the “c” in adMind.

Refer to adMind as “we,” not “it.”

Capitalize the proper names of adMind products, features, pages, and tools. When referencing non-trademarked products like Pro, Snap, and Automation, include "adMind" in the name on first mention.
...
- adMind's ops team is constantly scaling our servers to make sure our users have a great experience with our products. One way we do this is with shards, or partitions, that help us better horizontally scale our database infrastructure.
...
Use italics when citing an example of an in-app adMind element, or referencing button and navigation labels in step-by-step instructions:
